    ...
    roomsGrid.innerHTML = roomsData.map(room => `
        <div class="room-card" data-testid="room-card-${room.id}">
            ...
            <div class="card-content">
                ...
                <p class="card-description">Experience comfort and luxury with modern amenities and exceptional service.</p>
    ...
    hallsGrid.innerHTML = hallsData.map(hall => `
        <div class="hall-card" data-testid="hall-card-${hall.id}">
            ...
            <div class="card-content">
                ...
                <p class="card-description">Perfect venue for your events with state-of-the-art facilities and professional service.</p>
                <div class="card-features">
        ...
        return `
            <div class="booking-card" data-testid="booking-card-${booking.id}">
                ...
                <div class="booking-footer">
                    <div class="booking-total">₹${booking.totalAmount.toLocaleString('en-IN')}</div>
